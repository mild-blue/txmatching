...
class ConfigModel(db.Model):
    ...
    created_by = db.Column(db.BigInteger, unique=False, nullable=False)
...
class PairingResultModel(db.Model):
    ...
    config_id = db.Column(db.BigInteger, unique=False, nullable=False)
...
class PairingResultPatientModel(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    pairing_result_id = db.Column(db.BigInteger, ForeignKey('pairing_result.id'), unique=False, nullable=False)
    patient_id = db.Column(db.BigInteger, ForeignKey('patient.id'), unique=False, nullable=False)
    created_at = db.Column(db.DateTime(timezone=True), unique=False, nullable=False, server_default=func.now())
    updated_at = db.Column(db.DateTime(timezone=True), nullable=False, server_default=func.now(), onupdate=func.now())
    deleted_at = db.Column(db.DateTime(timezone=True), nullable=True)
