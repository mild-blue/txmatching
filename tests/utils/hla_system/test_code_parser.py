...
codes = {
    ...
    'B*46:11': (HLACode('B*46:11', 'B46', 'B46'), ParsingIssueDetail.MULTIPLE_SPLITS_OR_BROADS_FOUND),
    'B*15:11': (HLACode('B*15:11', 'B75', 'B15'), ParsingIssueDetail.MULTIPLE_SPLITS_OR_BROADS_FOUND),
    'B*53:06': (HLACode('B*53:06', 'B53', 'B53'), ParsingIssueDetail.MULTIPLE_SPLITS_OR_BROADS_FOUND),
    'C*12:14': (HLACode('C*12:14', 'CW12', 'CW12'), ParsingIssueDetail.MULTIPLE_SPLITS_OR_BROADS_FOUND),
    'DRB1*08:31': (HLACode('DRB1*08:31', 'DR11', 'DR5'), ParsingIssueDetail.MULTIPLE_SPLITS_OR_BROADS_FOUND),
    'DRB1*14:53': (HLACode('DRB1*14:53', 'DR13', 'DR6'), ParsingIssueDetail.MULTIPLE_SPLITS_OR_BROADS_FOUND),
