...
class TestCrossmatch(unittest.TestCase):
    ...
    def _assert_positive_crossmatch(self, hla_type: HLAType, hla_antibodies: List[HLAAntibody], use_split_resolution: bool):
        self.assertTrue(
            ...
            ), f'{hla_type} and {hla_antibodies} has NEGATIVE crossmatch (use_split_resolution={use_split_resolution})'
        )

    def _assert_negative_crossmatch(self, hla_type: HLAType, hla_antibodies: List[HLAAntibody], use_split_resolution: bool):
        self.assertFalse(
            is_positive_hla_crossmatch(
                HLATyping(hla_types_list=[hla_type]),
                HLAAntibodies(hla_antibodies_list=hla_antibodies),
                use_split_resolution
            ), f'{hla_type} and {hla_antibodies} has POSITIVE crossmatch (use_split_resolution={use_split_resolution})'
        )
