...
class TestCrossmatch(unittest.TestCase):
    ...
    def _assert_positive_crossmatch(self, hla_type: str, hla_antibodies: List[HLAAntibody], use_high_resolution: bool):
        self.assertTrue(
            is_positive_hla_crossmatch(
                get_hla_typing(hla_types_list=[hla_type]),
    ...
    def _assert_negative_crossmatch(self, hla_type_raw: str, hla_antibodies: List[HLAAntibody],
        ...
        self.assertFalse(
            is_positive_hla_crossmatch(
                get_hla_typing(hla_types_list=[hla_type_raw]),
                HLAAntibodies(hla_antibodies_list=hla_antibodies),
                use_high_resolution
            ),
    ...
    def test_crossmatch_split(self):
        ...
        self._assert_positive_crossmatch('A9', [HLAAntibody('A9', 2100, 2000)], False)
        self._assert_negative_crossmatch('A9', [HLAAntibody('A9', 1900, 2000)], False)

        self._assert_negative_crossmatch('A23', [HLAAntibody('A24', 2100, 2000)], False)

        # broad crossmatch
        self._assert_positive_crossmatch('A9', [HLAAntibody('A23', 2100, 2000)], False)
        self._assert_negative_crossmatch('A9', [HLAAntibody('A1', 2100, 2000)], False)

        # with high res code specified:

        # positive split crossmatch
        self._assert_positive_crossmatch('A*23:01', [HLAAntibody('A*23:04', 2100, 2000)], False)
        # negative split crossmatch
        self._assert_negative_crossmatch('A*23:01', [HLAAntibody('A*24:02', 2100, 2000)], False)
        # positive split crossmatch
        self._assert_positive_crossmatch('A*23:04', [HLAAntibody('A23', 2100, 2000)], False)
        # negative split crossmatch
        self._assert_negative_crossmatch('A*23:04', [HLAAntibody('A24', 2100, 2000)], False)
    ...
    def test_crossmatch_high_res(self):
        ...
        # positive high res crossmatch
        self._assert_positive_crossmatch('A*23:01', [HLAAntibody('A*23:01', 2100, 2000)], True)
        # positive split crossmatch
        self._assert_positive_crossmatch('A*23:01', [HLAAntibody('A*23:04', 2100, 2000)], True)
        # positive split crossmatch
        self._assert_positive_crossmatch('A23', [HLAAntibody('A*23:04', 2100, 2000)], True)
        # positive split crossmatch
        self._assert_positive_crossmatch('A*23:04', [HLAAntibody('A23', 2100, 2000)], True)
        # positive split crossmatch
        self._assert_positive_crossmatch('A23', [HLAAntibody('A23', 2100, 2000)], True)
        # negative split crossmatch
        self._assert_negative_crossmatch('A24', [HLAAntibody('A*23:04', 2100, 2000)], True)
        # negative split crossmatch
        self._assert_negative_crossmatch('A*23:04', [HLAAntibody('A24', 2100, 2000)], True)
        # negative split crossmatch
        self._assert_negative_crossmatch('A23', [HLAAntibody('A24', 2100, 2000)], True)
        # negative split crossmatch
        self._assert_negative_crossmatch('A*23:01', [HLAAntibody('A*24:02', 2100, 2000)], True)

        # mfi < cutoff:

        # negative high res crossmatch
        self._assert_negative_crossmatch('A*23:01', [HLAAntibody('A*23:01', 1900, 2000)], True)
        # negative split crossmatch
        self._assert_negative_crossmatch('A23', [HLAAntibody('A*23:04', 1900, 2000)], True)
        # negative split crossmatch
        self._assert_negative_crossmatch('A*23:04', [HLAAntibody('A23', 1900, 2000)], True)
        # negative split crossmatch
        self._assert_negative_crossmatch('A23', [HLAAntibody('A23', 1900, 2000)], True)
    ...
    def test_get_crossmatched_antibodies(self):
        ...
        # positive high res crossmatch
        self._assert_matches_equal('A*23:01', [HLAAntibody('A*23:01', 2100, 2000)], True,
                                   [AntibodyMatch(HLAAntibody('A*23:01', 2100, 2000), AntibodyMatchTypes.HIGH_RES)])
        # positive split crossmatch
        self._assert_matches_equal('A*23:01', [HLAAntibody('A*23:04', 2100, 2000)], True,
                                   [AntibodyMatch(HLAAntibody('A*23:04', 2100, 2000), AntibodyMatchTypes.SPLIT)])
        # negative split crossmatch
        self._assert_matches_equal('A*23:01', [HLAAntibody('A*24:02', 2100, 2000)], True,
                                   [AntibodyMatch(HLAAntibody('A*24:02', 2100, 2000), AntibodyMatchTypes.NONE)])

        # mfi < cutoff:

        # negative high res crossmatch
        self._assert_matches_equal('A*01:01', [HLAAntibody('A*23:01', 2100, 2000)], True,
                                   [AntibodyMatch(HLAAntibody('A*23:01', 2100, 2000), AntibodyMatchTypes.NONE)])
