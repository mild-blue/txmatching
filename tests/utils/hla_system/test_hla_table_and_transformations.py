...
class TestHlaTable(unittest.TestCase):
    def test_a_b_dr_hla_code_regex(self):
        self.assertIsNotNone(re.match(HLA_GROUPS_PROPERTIES[HLAGroup.DRB1].split_code_regex, 'DR1'))
        self.assertIsNotNone(re.match(HLA_GROUPS_PROPERTIES[HLAGroup.DRB1].split_code_regex, 'DR11'))
        self.assertIsNotNone(re.match(HLA_GROUPS_PROPERTIES[HLAGroup.A].split_code_regex, 'A11'))
        self.assertIsNone(re.match(HLA_GROUPS_PROPERTIES[HLAGroup.DRB1].split_code_regex, 'DR51'))
        self.assertIsNone(re.match(HLA_GROUPS_PROPERTIES[HLAGroup.DRB1].split_code_regex, 'DR52'))
        self.assertIsNone(re.match(HLA_GROUPS_PROPERTIES[HLAGroup.DRB1].split_code_regex, 'DR53'))
        self.assertIsNotNone(re.match(HLA_GROUPS_PROPERTIES[HLAGroup.DRB1].split_code_regex, 'DR5'))
    ...
    def test_high_res_code_regex(self):
        ...
        self.assertIsNotNone(re.match(HIGH_RES_REGEX_ENDING_WITH_LETTER, 'C*11:45N'))
        self.assertIsNone(re.match(HIGH_RES_REGEX_ENDING_WITH_LETTER, 'KV*23N'))
        self.assertIsNone(re.match(HIGH_RES_REGEX_ENDING_WITH_LETTER, 'DPB1*1110:01'))
        self.assertIsNotNone(re.match(HIGH_RES_REGEX_ENDING_WITH_LETTER, 'DPB1*1110:01N'))
    ...
    def test_ultra_high_res_code_regex(self):
        self.assertIsNotNone(re.match(HIGH_RES_REGEX, 'C*11:45:32:01'))
        self.assertIsNotNone(re.match(HIGH_RES_REGEX, 'C*11:45:32'))
        self.assertIsNone(re.match(HIGH_RES_REGEX, 'C*11:45:32N'))
        self.assertIsNone(re.match(HIGH_RES_REGEX, 'C*11:45:32Q'))

        match = re.search(HIGH_RES_REGEX, 'C*11:45:32')
        self.assertIsNotNone(match)
        self.assertEqual('C*11:45', match.group(1))

        match = re.search(HIGH_RES_REGEX, 'C*11:45:01:01:01:32')
        self.assertIsNotNone(match)
        self.assertEqual('C*11:45', match.group(1))

        match = re.search(HIGH_RES_REGEX, 'C*11:45')
        self.assertIsNotNone(match)
        self.assertEqual('C*11:45', match.group(1))

        match = re.search(HIGH_RES_REGEX, 'C*11')
