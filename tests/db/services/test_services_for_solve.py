...
from kidney_exchange.database.services.services_for_solve import get_config_models, get_patients_for_pairing_result, \
...
class TestSolveFromDbAndItsSupportFunctionality(unittest.TestCase):
    def test_caching_in_solve_from_db(self):
        ...
        with app.app_context():
            self.assertEqual(3, len(get_config_models()), "there should be 3 configs in the database")
