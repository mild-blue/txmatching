...
from txmatching.web import API_VERSION, PATIENT_NAMESPACE, USER_NAMESPACE
    ...
    def test_txm_event_multiple(self):
        ...
        with self.app.test_client() as client:
            self.assertEqual(0, len(
                client.get(f'{API_VERSION}/{PATIENT_NAMESPACE}', headers=self.auth_headers).json['donors']))
