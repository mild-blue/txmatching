...
class TestUpdateDonorRecipient(DbTests):
    ...
    def test_update_recipient(self):
        ...
        self.assertSetEqual({'B7', 'DQ6', 'DQ5'},
                            {hla_antibody['code']['display_code'] for hla_antibody in
        ...
        self.assertSetEqual({'B42', 'DQB1*06:03', 'DQA1*01:03'},
                            {hla_antibody['code']['display_code'] for hla_antibody in
                            RecipientModel.query.get(1).hla_antibodies['hla_antibodies_list']})
        self.assertTrue(
            RecipientModel.query.get(1).recipient_requirements['require_better_match_in_compatibility_index'])
        self.assertSetEqual({'A11', 'DQB1*06:03', 'DQA1*01:03'},
                            {hla_type['code']['display_code'] for hla_type in RecipientModel.query.get(1).hla_typing['hla_types_list']})
    ...
    def test_update_donor(self):
        ...
        self.assertSetEqual({'A11', 'DQB1*06:03', 'DQA1*01:03'},
                            {hla_type['code']['display_code'] for hla_type in DonorModel.query.get(1).hla_typing['hla_types_list']})
