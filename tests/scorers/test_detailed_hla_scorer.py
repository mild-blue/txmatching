...
class TestHlaScorer(DbTests):
    def test_get_genotype(self):
        ...
        expected = [
            ...
            DetailedCompatibilityIndexForHLAGroup(hla_group=HLAGroup.DPA,
                        donor_matches=[],
                        recipient_matches=[], group_compatibility_index=0.0),
            DetailedCompatibilityIndexForHLAGroup(hla_group=HLAGroup.DPB,
                                        donor_matches=[
                                            ...
                                            HLAMatch(hla_type=create_hla_type('DP10'),
                                                    match_type=MatchType.NONE)],
                                        recipient_matches=[], group_compatibility_index=0.0),
            DetailedCompatibilityIndexForHLAGroup(hla_group=HLAGroup.DQA,
                        donor_matches=[],
                        recipient_matches=[], group_compatibility_index=0.0),
            DetailedCompatibilityIndexForHLAGroup(hla_group=HLAGroup.DQB,
                                                  donor_matches=[
