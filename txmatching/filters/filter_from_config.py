...
def filter_from_config(config_parameters: ConfigParameters) -> FilterBase:
    # TODO handle filter properly: do all the stuff of filter already in solver and scorer https://trello.com/c/Cn2HCKLX
    return construct_configurable_object('FilterDefault', _supported_filters, config_parameters)
