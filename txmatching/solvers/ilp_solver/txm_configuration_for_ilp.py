...
class DataAndConfigurationForILPSolver:
    ...
    def __init__(self, active_and_valid_donors_dict: Dict[DonorDbId, Donor],
        ...
        self.graph = self._create_graph(config_parameters, active_and_valid_donors_dict, active_and_valid_recipients_dict)
        ...
        self.required_patients = [donor_db_id_to_idx[
                                      active_and_valid_donors_dict[
                                          active_and_valid_recipients_dict[recipient_db_id].related_donor_db_id].db_id]
                                  for
    ...
    def _create_graph(self,
        ...
        donor_score_matrix = self._get_donor_score_matrix(config_parameters, active_and_valid_donors_dict, active_and_valid_recipients_dict)
