...
from txmatching.data_transfer_objects.app_user.app_user import AppUserDTO
...
def get_current_user() -> Optional[AppUserDTO]:
    """
    ...
    return AppUserDTO(user_model.email, user_model.role, user_model.default_txm_event_id)
