...
import { ConfigurationGenerated, ConfigurationIdGenerated, IdentifierGenerated, SuccessGenerated } from '@app/generated';
...
export class ConfigurationService {
  ...
  public async findConfigurationId(txmEventId: number, payload: ConfigurationGenerated): Promise<ConfigurationId> {
    return firstValueFrom(
      this._http
      .post<ConfigurationIdGenerated>(`${environment.apiUrl}/txm-event/${txmEventId}/configuration/find-config-id`, payload)
