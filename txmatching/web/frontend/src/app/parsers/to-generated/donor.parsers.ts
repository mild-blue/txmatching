...
export const fromDonorEditableToUpdateGenerated = (
  donor: DonorEditable,
  donorId: number,
...
export const fromDonorType = (donorType: DonorType): DonorTypeGenerated => {
  switch (donorType) {
    case DonorType.DONOR:
      return DonorTypeGenerated.Donor;
    case DonorType.BRIDGING_DONOR:
      return DonorTypeGenerated.BridgingDonor;
    case DonorType.NON_DIRECTED:
      return DonorTypeGenerated.NonDirected;
    default:
      throw new Error(`Parsing from donor type ${donorType} not implemented`);
  }
};
