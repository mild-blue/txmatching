...
export const fromDonorEditableToUpdateGenerated = ( donor: DonorEditable, donorId: number, donorEtag: number ): DonorModelToUpdateGenerated => {
  return {
    ...fromPatientEditableToUpdateGenerated(donor, donorId, donorEtag),
    active: donor.active
  };
};
