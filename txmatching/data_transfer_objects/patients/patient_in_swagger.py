...
from txmatching.data_transfer_objects.base_patient_swagger import (
    DbId, DonorToUpdate, Etag, MedicalId, PatientHasConfirmedWarnings, PatientParametersJson, PatientToUpdate,
...
DonorJson = patient_api.model('Donor', {**DbId, **MedicalId, **Etag, **PatientHasConfirmedWarnings, **{
...
RecipientJson = patient_api.model('Recipient', {**DbId, **MedicalId, **Etag, **PatientHasConfirmedWarnings, **{
