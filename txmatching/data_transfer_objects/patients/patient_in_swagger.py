...
from txmatching.data_transfer_objects.base_patient_swagger import (
    DbId, DonorToUpdate, Etag, MedicalId, ActiveAndValid, PatientParametersJson, PatientToUpdate,
...
DonorJson = patient_api.model('Donor', {**DbId, **MedicalId, **Etag, **ActiveAndValid, **{
...
RecipientJson = patient_api.model('Recipient', {**DbId, **MedicalId, **Etag, **ActiveAndValid, **{
